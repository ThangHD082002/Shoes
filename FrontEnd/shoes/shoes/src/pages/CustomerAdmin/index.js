...
function CustomerAdmin() {
  ...
  const [customerRequestForFix, setCustomerRequestForFix] = useState({});
  ...
  const [roleCustomer, setRoleCustomer] = useState("role-customer");
  ...
  const [showAddCustomerForFix, setShowAddCustomerForFix] = useState(false);
  ...
  useEffect(() => {
    ...
    if(role == "CUSTOMER"){
      ...
      request.getCustomerByName("user-by-username-and-role", {
          headers: {
            Authorization: `Bearer ${varToken}`},
            params: {
              username: input,
...
const handleChangePhone = (e) => {
  ...
  function handleCancel(){
    ...
    setShowAddCustomerForFix(false);
  }
  ...
  useEffect(() => {
    if(customerRequestForFix[0]){
      setEmail(customerRequestForFix[0].username);
      setPhone(customerRequestForFix[0].phone);
      setGender(customerRequestForFix[0].gender);
      setStatus(customerRequestForFix[0].su);
      setRole(customerRequestForFix[0].roles[0].name)
    }
  ...
  function handleShowInfor(user){
    ...
    request
      ...
      .then(function (response) {
        // handle success
        // console.log(response);
        setCustomerRequestForFix(response);
      ...
      {showAddCustomer &&
         ...
         <button className={cx("btn-x")} onClick={handleCancel}><FontAwesomeIcon icon={faXmark} className={cx("btn-icon")}/></button>
           <div className={cx("login-header")}>
             <h1 className={cx("title")}>Thêm khách hàng</h1>
      ...
      <div className={cx("grid")}>
        <div className={cx("manager-contain")}>
          <div className={cx("title-contain")}>
            ...
            <div className={cx("add-manager")} onClick={handleAddCustomer}>
              <p>
                {" "}
          ...
          <div className={cx("table-contain")}>
            <table>
              ...
              <tbody>
                {customerRequest.map((c) => (
                  <tr>
                    <td>
                      <p className={cx("name")}>{c.username}</p>
                    </td>
                    <td className={cx("name")}>
                      <p className={cx("phone")}>{c.phone}</p>
                    </td>
                    <td>
                    ...
                    <td>
                      <p className={cx("date-created")}>{c.dateCreated}</p>
                    </td>
                    <td>
                      <p className={roleCustomer}>{c.roles[0].name}</p>
                    </td>
                    <td>
                    ...
                    <ul className={cx("action-list")}>
                        ...
                        <li className={cx("action-item")} onClick={() => handleShowInfor(c.username)}>Sửa</li>
