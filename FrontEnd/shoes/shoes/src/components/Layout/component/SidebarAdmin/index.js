...
import { faFirstOrder, faJediOrder } from "@fortawesome/free-brands-svg-icons";
import { faCartShopping, faChartLine, faCircleInfo, faFire, faList, faRocket, faUserAlt, faUsers } from "@fortawesome/free-solid-svg-icons";
    ...
    return(
        <div className={cx("sidebar-contain")}>
            ...
            <div className={cx("menu")}>
                <p className={cx("menu-title")}>MENU</p>
                <ul className={cx("menu-list")}>

                    <li className={cx("menu-item")}>
                        <a className={cx("menu-item-link")} href={`/admin/chart`}><FontAwesomeIcon icon={faChartLine} className={cx("menu-icon")}/> Thống kê</a>
                    </li>
                    <li className={cx("menu-item")}>
                        <a className={cx("menu-item-link")} href={`/admin`}><FontAwesomeIcon icon={faUser} className={cx("menu-icon")} /> Quản lí</a>
                    </li>
                    <li className={cx("menu-item")}>
                        <a className={cx("menu-item-link")} href={`/admin/customer`}><FontAwesomeIcon icon={faUsers} className={cx("menu-icon")}/> Khách hàng</a>
                    </li>
                    <li className={cx("menu-item")}>
                        <a className={cx("menu-item-link")} href={`/admin/employee`}><FontAwesomeIcon icon={faUserAlt} className={cx("menu-icon")}/> Nhân viên</a>
                    </li>
                    <li className={cx("menu-item")}>
                        <a className={cx("menu-item-link")} href={`/admin/orders`}><FontAwesomeIcon icon={faFire} className={cx("menu-icon")}/> Hoá đơn</a>
                    </li>
                    <li className={cx("menu-item")}>
                        <a className={cx("menu-item-link")} href={`/admin/order-details`}><FontAwesomeIcon icon={faCartShopping   } className={cx("menu-icon")}/> Chi tiết hoá đơn</a>
                    </li>
                    <li className={cx("menu-item")}>
                        <a className={cx("menu-item-link")} href={`/admin/products`}><FontAwesomeIcon icon={faList} className={cx("menu-icon")}/> Sản phẩm</a>
                    </li>

                    <li className={cx("menu-item")}>
                        <a className={cx("menu-item-link")} href={`/admin/product-details`}><FontAwesomeIcon icon={faCircleInfo} className={cx("menu-icon")}/> Chi tiết sản phẩm</a>
                    </li>

                    <li className={cx("menu-item")}>
                        <a className={cx("menu-item-link")}><FontAwesomeIcon icon={faRocket} className={cx("menu-icon")}/> Thương hiệu</a>
                    </li>
                </ul>
                <div className={cx("footer")}>
                    <p className={cx("footer-text")}>ShoesUni: Manage</p>
                </div>
            </div>
        </div>
    )
