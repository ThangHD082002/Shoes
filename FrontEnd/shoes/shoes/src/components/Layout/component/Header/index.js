...
function Header() {
  ...
  function handleShowAction(){
    if(showActionUser === "show-user-none"){
      setShowActionUser("show-user-block");
    }
    else{
      ...
      <div className={cx("header")} >
        <div className={cx("grid")}>
          <div className={cx("header-navbar")}>
            ...
            <ul className={cx("navbar-list")}>
              <li className={cx("navbar-item")}>
                <a className={cx("navbar-item-link")} href={`my-order`}>
                  <FontAwesomeIcon
                    icon={faBell}
              ...
              {checkLogin && (
                <div className={cx("navbar-login")}>
                  <p className={cx("email-title")} onClick={handleShowAction}>{email} <FontAwesomeIcon icon={faChevronDown} className={cx("user-icon")}/></p>
                  <ul className={showActionUser}>
                    <li className={cx("user-item")}>Thông tin tài khoản</li>
                    <li className={cx("user-item")} onClick={handlLogout}>Đăng xuất</li>
                  </ul>
                </div>
              )}

              {!checkLogin && (
                <li className={cx("user-login") } onClick={handleLogin}>Đăng nhập <FontAwesomeIcon icon={faUser} className={cx("login-icon")} /></li>
              )}
            </ul>
          ...
          <div className={cx("header-menu")}>
            ...
            <div className={cx("cart")}>
              <a href={`/cart`} className={cx("cart-link")}>
